...
import com.dragomir.webstore.domain.CartItem;
...
//	The @ResponseBody annotation will convert the given Java object into JSON/XML format and send it as a
//	response in the body of an HTTP response. Similarly, when you send an HTTP request to a
//	controller method with JSON/XML data in it, the @RequestBody annotation will convert it
