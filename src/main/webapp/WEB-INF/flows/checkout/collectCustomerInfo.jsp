	...
	<section class="container">
		<form:form modelAttribute="order.customer" class="formhorizontal">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="doorNo">Door Nr</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="phoneNumber">Phone Nr</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						<input type="submit" id="btnAdd" class="btn btnprimary"	value="Add" name="_eventId_customerInfoCollected" />
